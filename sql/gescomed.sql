...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-08-2025 a las 20:12:02
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_paciente_crud` (IN `p_operacion` VARCHAR(10), IN `p_id_paciente` INT, IN `p_nombre` VARCHAR(50), IN `p_apellido` VARCHAR(50), IN `p_fecha_nacimiento` DATE, IN `p_telefono` VARCHAR(15), IN `p_direccion` VARCHAR(100), IN `p_email` VARCHAR(100))   BEGIN
...
(5, 1, 4, '2025-09-15', '14:00:00', 'pendiente'),
(6, 5, 5, '2025-08-20', '16:00:00', 'atendida'),
(7, 6, 2, '2025-08-29', '14:00:00', 'pendiente'),
(8, 6, 1, '2025-08-29', '14:00:00', 'pendiente'),
(9, 5, 4, '2025-08-29', '14:05:00', 'pendiente');
...
(1, 2, 250.00, 'pagada', '2025-09-10'),
(2, 6, 300.00, 'pendiente', '2025-08-21'),
(3, 1, 150.00, 'pendiente', '2025-08-29');
...
(3, 5, 'Migraña crónica', 'Analgésicos y seguimiento neurológico.', '2025-08-20');
...
INSERT INTO `paciente` (`id_paciente`, `nombre`, `apellido`, `fecha_nacimiento`, `telefono`, `direccion`, `email`) VALUES
(1, 'Maria', 'Gonzalez', '1990-05-15', '66611122', 'Calle Falsa 123', 'maria.g@email.com'),
(2, 'Jose', 'Rodriguez', '1985-11-20', '66633344', 'Avenida Siempreviva 742', 'jose.r@email.com'),
(3, 'Laura', 'Perez', '2018-02-10', '66655566', 'Plaza Mayor 1', 'laura.p@email.com'),
(4, 'Pedro', 'Sanchez', '1973-07-30', '66677788', 'Calle Luna 24', 'pedro.s@email.com'),
(5, 'Elena', 'Ramirez', '1995-09-01', '66699900', 'Avenida del Sol 50', 'elena.r@email.com'),
(6, 'Gunnar', 'Pecho Vallejos', '1990-09-24', '79755532', 'Manuela Saavedra', 'lui@gmail.com');
